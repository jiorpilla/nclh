 ...
 */
final class Version20240128063040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', crew_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', appointment_date DATE DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, package INT DEFAULT NULL, deleted SMALLINT DEFAULT 0 NOT NULL, created_by BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', updated_by BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_FE38F8445FE259F6 (crew_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
